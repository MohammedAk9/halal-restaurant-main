...
import { auth } from './firebase'; // Import your firebase.js
        ...
        >
          ...
          >
            <Toolbar sx={{ justifyContent: 'space-between', maxWidth: 'lg', width: '100%', mx: 'auto' }}>
              ...
              {/* Show logged-in user or Login/Signup buttons */}
              {currentUser ? (
              ...
              <Button component={Link} to="/create-recipe" color="inherit">
                Create Recipe
              </Button>
            </Toolbar>
          </AppBar>
          ...
          <Routes>
            ...
            {/* Create Recipe Page */}
            <Route path="/create-recipe" element={<CreateRecipe />} /> {/* Add CreateRecipe page */}
          </Routes>
        </Box>
      </Box>
    </Router>
